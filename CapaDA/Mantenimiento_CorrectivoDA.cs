...
namespace CapaDA
{
    class Mantenimiento_CorrectivoDA
    {
    ...
    public class ClsMantenimiento_CorrectivoDA
    {
        ...
        {
            SqlCommand CMD = new SqlCommand("PA_MANTENIMIENTO_CORRECTIVO_INSERTA");
            ...
            return Mantenimiento_CorrectivoDA.Acceder(CMD);

        }

        public static ENResultOperation Actualizar(ClsMantenimiento_CorrectivoBE Datos)
        {
            SqlCommand CMD = new SqlCommand("PA_MANTENIMIENTO_CORRECTIVO_MODIFICA");
            CMD.Parameters.Add(Parametros_SQL.nombre_error, SqlDbType.VarChar).Value = "";
            CMD.Parameters.Add(Parametros_SQL.ide, SqlDbType.Int).Value = Datos.Mant_ide;
            CMD.Parameters.Add(Parametros_SQL.tran_ide, SqlDbType.Int).Value = Datos.Tran_ide;
            CMD.Parameters.Add(Parametros_SQL.vehi_ide, SqlDbType.Int).Value = Datos.Tran_vehi_ide;
        ...
        {
            SqlCommand CMD = new SqlCommand("PA_MANTENIMIENTO_CORRECTIVO_ELIMINA");
        ...
        {
            SqlCommand CMD = new SqlCommand("SELECT * FROM V_MANTENIMIENTO_CORRECTIVO");
        ...
        {
            SqlCommand CMD = new SqlCommand("PA_MANTENIMIENTO_CORRECTIVO_LISTAR_FILTRO");
        ...
        {
            SqlCommand CMD = new SqlCommand("PA_MANTENIMIENTO_CORRECTIVO_LISTAR_POR_FECHAS");
            CMD.Parameters.Add(Parametros_SQL.nombre_error, SqlDbType.VarChar).Value = DBNull.Value;
            CMD.Parameters.Add("@FECINI", SqlDbType.DateTime).Value = FecIni;
            CMD.Parameters.Add("@FECFIN", SqlDbType.DateTime).Value = FecFin;
        ...
        {
            SqlCommand CMD = new SqlCommand("SELECT * FROM V_MANTENIMIENTO_CORRECTIVO WHERE Mant_Ide = @IDE");
        ...
        {
            SqlCommand CMD = new SqlCommand("SELECT * FROM MANTENIMIENTO_CORRECTIVO WHERE Mant_Ide = " + Reco_Ide.ToString());
