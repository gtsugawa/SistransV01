...
namespace CapaDA
{
    ...
    public class ClsCategoria_ProveedorDA
    {
        ...
        {
            SqlCommand CMD = new SqlCommand("PA_CATEGORIA_PROVEEDOR_INSERTA");
            CMD.Parameters.Add(Parametros_SQL.nombre_error, SqlDbType.VarChar).Value = "";
            CMD.Parameters.Add(Parametros_SQL.codigo, SqlDbType.Int).Value = Datos.Cate_prov_ide;
            CMD.Parameters.Add(Parametros_SQL.nombre, SqlDbType.VarChar).Value = Datos.Cate_prov_nombre;
            CMD.Parameters.Add(Parametros_SQL.estado, SqlDbType.VarChar).Value = Datos.Cate_prov_estado;
            CMD.Parameters.Add(Parametros_SQL.inactiva, SqlDbType.DateTime).Value = Datos.Cate_prov_fechainac;
            ...
            return Categoria_ProveedorDA.Acceder(CMD);
        }

        public static ENResultOperation Actualizar(ClsCategoria_ProveedorBE Datos)
        {
            SqlCommand CMD = new SqlCommand("PA_CATEGORIA_PROVEEDOR_MODIFICA");
            CMD.Parameters.Add(Parametros_SQL.nombre_error, SqlDbType.VarChar).Value = "";
            CMD.Parameters.Add(Parametros_SQL.ide, SqlDbType.Int).Value = Datos.Cate_prov_ide;
            CMD.Parameters.Add(Parametros_SQL.nombre, SqlDbType.VarChar).Value = Datos.Cate_prov_nombre;
            CMD.Parameters.Add(Parametros_SQL.estado, SqlDbType.VarChar).Value = Datos.Cate_prov_estado;
            CMD.Parameters.Add(Parametros_SQL.inactiva, SqlDbType.DateTime).Value = Datos.Cate_prov_fechainac;
            CMD.Parameters.Add(Parametros_SQL.veces, SqlDbType.Int).Value = Datos.Veces;
        ...
        {
            SqlCommand CMD = new SqlCommand("PA_CATEGORIA_PROVEEDOR_ELIMINA");
            CMD.Parameters.Add(Parametros_SQL.nombre_error, SqlDbType.VarChar).Value = "";
            CMD.Parameters.Add(Parametros_SQL.ide, SqlDbType.Int).Value = Datos.Cate_prov_ide;
            CMD.Parameters.Add(Parametros_SQL.veces, SqlDbType.Int).Value = Datos.Veces;
            CMD.Parameters.Add(Parametros_SQL.usuario, SqlDbType.VarChar).Value = Datos.Usuario;
        ...
        public static ENResultOperation Listar(string Texto_Buscar)
        {
            ...
            SqlCommand CMD = new SqlCommand("SELECT * FROM  CATEGORIA_PROVEEDOR WHERE CATE_PROV_NOMBRE LIKE '" +
                                   Texto_Buscar + "%'");
            return Tipo_ProveedorDA.Procesar_SQL(CMD);
            /*
            SqlCommand CMD = new SqlCommand("PA_CATEGORIA_PROVEEDOR_LISTAR");
        ...
        {
            SqlCommand CMD = new SqlCommand("PA_CATEGORIA_PROVEEDOR_LISTAR_FILTRO");
            CMD.Parameters.Add(Parametros_SQL.nombre_error, SqlDbType.VarChar).Value = Texto_Buscar;
