...
{
    public partial class rptMant_Preventivo : Form
    {
        ...
        private void rptMant_Preventivo_Load(object sender, EventArgs e)
        {
            // TODO: esta línea de código carga datos en la tabla 'DataSetMant_Preventivo.V_MANTENIMIENTO_PREVENTIVO' Puede moverla o quitarla según sea necesario.
            this.V_MANTENIMIENTO_PREVENTIVOTableAdapter.Fill(this.DataSetMant_Preventivo.V_MANTENIMIENTO_PREVENTIVO, fecha1, fecha2);
