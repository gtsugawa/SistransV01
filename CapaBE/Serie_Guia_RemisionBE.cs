...
namespace CapaBE
{
    class Serie_Guia_RemisionBE
    {
    }
    public class ClsSerie_Guia_RemisionBE
    {
        string serie_numero;
        int serie_contador;
        ...
        DateTime creacion;
        int veces;
        string serie_anterior;
        string nombre_error;
        string texto_buscar;
        string usuario;
        public ClsSerie_Guia_RemisionBE()
        {
        }
        public ClsSerie_Guia_RemisionBE(string serie_numero, int serie_contador, int serie_numero_lineas, string serie_nombre_lugar, string serie_terminal_formato, int tienda_ide, string serie_estado, DateTime serie_fechainac, DateTime creacion, int veces, string serie_anterior,string nombre_error, string texto_buscar, string usuario)
        {
